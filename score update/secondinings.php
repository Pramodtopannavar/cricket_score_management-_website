...
$bowlingTeam='';
if ($tossResult === $team1) {
    $bowlingTeam = ($tosselected === "Bat") ? $team1 : $team2;
    $battingTeam = ($tosselected === "Bowl") ? $team1 : $team2;
} elseif ($tossResult === $team2) {
    $bowlingTeam = ($tosselected === "Bat") ? $team2 : $team1;
    $battingTeam= ($tosselected === "Bowl") ? $team2 : $team1;
}
...
<body>
     ...
     <div id="second_innings">
     
      <div class="page_title_section">
        <p class="cricket_ti"><i>Second Innings</i></p>
      ...
      <div class="add_score">
        <div class="first_team_add_score">
          <form action="sbatingupdate.php?database=<?php echo $databaseName ?>&battingteam=<?php echo $batting_team ?>&bowlingteam=<?php echo $bowling_team?>" method="post" class="add_score_section_form_ft">
        ...
        <?php } ?>
          ...
          <div class="first_team_add_score">
            ...
            <form action="sbowlingupdate.php?database=<?php echo $databaseName ?>&bowlingteam=<?php echo $bowling_team ?>&battingteam=<?php echo $batting_team ?>" method="post"class="add_score_section_form_ft"  method="post">
              <div class="form_header">
...
<!-- PREVIEW -->
        ...
        <div class="first_team_score_preview2">
          ...
          <form action="movetofirst.php?database=<?php echo $databaseName ?>" method="post" class="centered-form">
      
      <input  id="saveForm" class="button_text styled-button"  type="submit" name="submit" value="Firstinings" />
  </form>
  <form action="/homepage/homepage/index.html" method="post" class="centered-form" onsubmit="return confirmSubmission();">
  
      <input id="saveForm" class="button_text styled1-button" type="submit" name="submit" value="Match Complete"  />
  </form>
    ...
    function confirmSubmission() {
        ...
        return confirm("Are you sure you want to complete the match?");
