...
<!-- PREVIEW -->
        ...
        <div class="first_team_score_preview2">
          ...
          <form action="show.php?database=<?php echo $databaseName ?>" method="post" class="centered-form">
  ...
  <form action="/homepage/homepage/index.html" method="post" class="centered-form" onsubmit="return confirmSubmission();">
      ...
      <input id="saveForm" class="button_text styled1-button" type="submit" name="submit" value="Exit"  />
  </form>
    ...
    function confirmSubmission() {
        ...
        return confirm("Are you sure you want Exit?");
